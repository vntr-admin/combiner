...
public class SparBefriendingStrategyTest {
    ...
    private static Scenario getScenario1() {
        ...
        Set<Integer> partitionsWithoutAlphaOrBetaMasters = new HashSet<Integer>(manager.getAllPartitionIds());
    ...
    private static Scenario getScenario2() {
        ...
        Integer partitionBId = alpha.getReplicaPartitionIds().iterator().next();
        SparUser beta = SparTestUtils.getUserWithMasterOnPartition(manager, partitionBId);
    ...
    private static Scenario getScenario3() {
        ...
        Set<Integer> locationsWhereWeCouldReplicateBeta = new HashSet<Integer>(SparTestUtils.getPartitionsWithNoPresence(manager, beta.getId()));
    ...
    private static Scenario getScenario4() {
        ...
        if (!beta.getReplicaPartitionIds().contains(partitionAId)) {
            Integer betaReplicaToNix = beta.getReplicaPartitionIds().iterator().next();
    ...
    private static Scenario getScenario8() {
        ...
        Set<Integer> otherUsersInA = new HashSet<Integer>(manager.getPartitionById(partitionAId).getIdsOfMasters());
        ...
        if (!aleph.getReplicaPartitionIds().contains(partitionBId)) {
            Integer partitionForAlephToLeave = aleph.getReplicaPartitionIds().iterator().next();
    ...
    private static Scenario getScenario12() {
        ...
        if (!aleph.getReplicaPartitionIds().contains(partitionBId)) {
            Integer alephReplicaToNix = aleph.getReplicaPartitionIds().iterator().next();
    ...
    private static Scenario getScenario13() {
        ...
        Set<Integer> otherPartitions = new HashSet<Integer>(manager.getAllPartitionIds());
        ...
        for (Integer gammaReplicaId : new HashSet<Integer>(gamma.getReplicaPartitionIds())) {
        ...
        if (!alpha.getReplicaPartitionIds().contains(partitionCId)) {
            Integer alphaReplicaToNix = alpha.getReplicaPartitionIds().iterator().next();
    ...
    private static Scenario getScenario14() {
        ...
        if (!gamma.getReplicaPartitionIds().contains(partitionAId)) {
            Integer partitionToDitch = gamma.getReplicaPartitionIds().iterator().next();
            manager.removeReplica(gamma, partitionToDitch);
            manager.addReplica(gamma, partitionAId);
        }
        if (!alpha.getReplicaPartitionIds().contains(partitionCId)) {
            Integer partitionToDitch = alpha.getReplicaPartitionIds().iterator().next();
            manager.removeReplica(alpha, partitionToDitch);
            manager.addReplica(alpha, partitionCId);
        }
        if (!aleph.getReplicaPartitionIds().contains(partitionCId)) {
            Integer partitionToDitch = aleph.getReplicaPartitionIds().iterator().next();
    ...
    public void testCalcNumReplicasNoMovementOneCrossReplica() {
        ...
        if (!alpha.getReplicaPartitionIds().contains(partitionBId)) {
            Integer partitionFromWhichToRemoveAlpha = alpha.getReplicaPartitionIds().iterator().next();
    ...
    public void testCalcNumReplicasNoMovementTwoCrossReplicas() {
        ...
        if (!beta.getReplicaPartitionIds().contains(partitionAId)) {
            Integer partitionFromWhichToRemoveBeta = beta.getReplicaPartitionIds().iterator().next();
    ...
    public void testFindReplicasToAddToTargetPartition() {
        ...
        Set<Integer> targetPartitionIds = new HashSet<Integer>(manager.getAllPartitionIds());
    ...
    public void testFindReplicasInMovingPartitionToDeleteIsolatedMoverFriendsMeetRedundancyRequirement() {
        ...
        Integer partitionWithSingleMasterId = isolatedUser.getMasterPartitionId();
        Set<Integer> nonColocatedUsers = new HashSet<Integer>();
        for (Integer userId : SparTestUtils.STANDAR_USER_ID_ARRAY) {
            ...
            if (!user.getReplicaPartitionIds().contains(partitionWithSingleMasterId) && !userId.equals(isolatedUser.getId())) {
                ...
                boolean isolatedIdIsSmaller = isolatedUser.getId().intValue() < userId.intValue();
    ...
    public void testFindReplicasInMovingPartitionToDeleteIsolatedMoverFriendsMeetRedundancyRequirementWithNewlyAddedReplicas() {
        ...
        Set<Integer> replicasToDelete = strategy.findReplicasInMovingPartitionToDelete(isolatedUser, new HashSet<Integer>(Arrays.asList(colocatedFriendId)));
    ...
    public void testFindReplicasInPartitionThatWereOnlyThereForThisUsersSake() {
        ...
        Set<Integer> usersInPartitionWithSingleMaster = new HashSet<Integer>();
        for (Integer userId : SparTestUtils.STANDAR_USER_ID_ARRAY) {
            if (manager.getPartitionById(manager.getUserMasterById(userId).getMasterPartitionId()).getNumMasters() == 1) {
    ...
    public void testShouldWeDeleteReplicaOfStayingUserInMovingPartitionReplicaOtherFriends() {
        ...
        Set<Integer> otherUsersOnMovingPartition = new HashSet<Integer>(movingPartition.getIdsOfMasters());
