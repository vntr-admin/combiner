...
public class SpJ2MigrationStrategyTest {
    ...
    public void testScoreReplicaPromotion() {
        SpJ2Manager manager = new SpJ2Manager(2, 1, 2, 0.5f, 15, 0);
        SpJ2MigrationStrategy strategy = new SpJ2MigrationStrategy(manager);
    ...
    public void testGetUserMigrationStrategy() {
        ...
        SpJ2Manager manager = SpJ2InitUtils.initGraph(minNumReplicas+1, 1, 2, 0.5f, 15, 0, partitions, friendships, replicaPartitions);
